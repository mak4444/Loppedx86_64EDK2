...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gOvmfFwCfgInfoHobGuid = {0xa291ce0e, 0xdc09, 0x11ee, {0x9e, 0xdb, 0x73, 0x49, 0xd7, 0x92, 0xaf, 0x51}};
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiPeiMpServices2PpiGuid = { 0x5cb9cb3d, 0x31a4, 0x480c, { 0x94, 0x98, 0x29, 0xd2, 0x69, 0xba, 0xcf, 0xba}};
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEdkiiCcPpiGuid = { 0x8c8f17c3, 0xbb8d, 0x4d4e, { 0x96, 0x0e, 0xd3, 0x33, 0xcf, 0x2b, 0xcb, 0x20 }};
...
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdQemuVarsRequire = _PCD_VALUE_PcdQemuVarsRequire;
...
#define _PCD_VALUE_PcdOvmfSecValidatedEnd  0U
...
#define _PCD_VALUE_PcdOvmfSecValidatedStart  0U
...
#define _PCD_VALUE_PcdOvmfFlashNvStorageVariableBase  0xFFE00000U
...
#define _PCD_VALUE_PcdCfvRawDataSize  0x20000U

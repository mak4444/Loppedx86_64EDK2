...
#define STACK_COOKIE_VALUE 0xCB2441599B2C3ECFULL
...
#define _PCD_TOKEN_PcdQemuVarsRequire  0U
#define _PCD_SIZE_PcdQemuVarsRequire 1
#define _PCD_GET_MODE_SIZE_PcdQemuVarsRequire  _PCD_SIZE_PcdQemuVarsRequire 
#define _PCD_VALUE_PcdQemuVarsRequire  ((BOOLEAN)0U)
extern const  BOOLEAN  _gPcd_FixedAtBuild_PcdQemuVarsRequire;
#define _PCD_GET_MODE_BOOL_PcdQemuVarsRequire  _gPcd_FixedAtBuild_PcdQemuVarsRequire
//#define _PCD_SET_MODE_BOOL_PcdQemuVarsRequire  ASSERT(FALSE)  // It is not allowed to set value for a FIXED_AT_BUILD PCD
...
#define _PCD_VALUE_PcdOvmfDxeMemFvSize  0xe80000U
...
#define _PCD_VALUE_PcdOvmfDecompressionScratchEnd  0x0U
...
#define _PCD_VALUE_PcdFlashNvStorageFtwSpareSize  0x10000U
...
#define _PCD_VALUE_PcdFlashNvStorageVariableSize  0xE000U

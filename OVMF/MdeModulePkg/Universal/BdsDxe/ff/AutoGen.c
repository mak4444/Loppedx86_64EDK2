...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gUiAppFileGuid = {0x462CAA21, 0x7614, 0x4503, {0x83, 0x6E, 0x8A, 0xB6, 0xF4, 0x66, 0x23, 0x31}};
...
#define _PCD_TOKEN_PcdEmuVariableEvent  43U
...
#define _PCD_TOKEN_PcdOvmfFlashVariablesEnable  44U

...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiDelayedDispatchTableGuid = { 0x4b733449, 0x8eff, 0x488c, { 0x92, 0x1a, 0x15, 0x4a, 0xda, 0x25, 0x18, 0x07 }};
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiPeiDelayedDispatchPpiGuid = { 0x869c711d, 0x649c, 0x44fe, { 0x8b, 0x9e, 0x2c, 0xbb, 0x29, 0x11, 0xc3, 0xe6 }};
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdDelayedDispatchMaxDelayUs = _PCD_VALUE_PcdDelayedDispatchMaxDelayUs;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdDelayedDispatchCompletionTimeoutUs = _PCD_VALUE_PcdDelayedDispatchCompletionTimeoutUs;
